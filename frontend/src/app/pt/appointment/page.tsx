...
export default function PTAppointmentPage() {
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-500">Trial and consultation schedule</p>
        </div>
...
"
        ...
        <Link
          href="/dashboard/pt/appointment/create"
          className="
bg-primary
text-white
px-4
...
${item.status === "Done" ? "bg-green-100 text-green-700" : item.status === "Cancelled" ? "bg-red-100 text-red-700" : "bg-yellow-100 text-yellow-700"}
...
`}
                ...
                <td>
                  <Link
                    href={`/dashboard/pt/appointment/${item.id}/edit`}
                    className="
text-gray-500
hover:text-primary
"
